...
declare class CryptoJS {
    ...
    static MD5: (message: string) => Uint8Array;
    static SHA1: (message: string) => Uint8Array;
    static SHA256: (message: string) => Uint8Array;
    static SHA512: (message: string) => Uint8Array;
    static SHA3: (message: string) => Uint8Array;
    static RIPEMD160: (message: string) => Uint8Array;
    static enc: {
